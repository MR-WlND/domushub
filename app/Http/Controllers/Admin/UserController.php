...
class UserController extends Controller
{
    ...
    {
        // Khởi tạo query từ Model User — chỉ lấy nhân sự nội bộ (dùng scopeInternalStaff)
    ...
    public function update(Request $request, $id)
    {
        ...
        // Nếu user có gắn với hồ sơ staff, đồng bộ tên & SĐT qua Staff
        if ($user->staff) {
            $user->staff->update([
        ...
        SystemLogger::log('Sửa hồ sơ & phân quyền nhân viên', 'Nhân viên: ' . $user->name);

        return redirect()->route('admin.roles.index')->with('success', 'Cập nhật hồ sơ & phân quyền nhân sự thành công!');
    }
