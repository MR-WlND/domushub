...
class TemporaryRegistrationController extends Controller
{
    public function index(Request $request)
    {
        ...
        $stats = [
            'total_new' => TemporaryRegistration::whereDate('created_at', today())->count(),
        ...
        return view('receptionist.temporary-registrations.index', compact('registrations', 'stats'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('receptionist.temporary-registrations.create', compact('users', 'blocks', 'extendRegistration'));
    }
    ...
    public function edit(TemporaryRegistration $temporaryRegistration)
    {
        $users = User::where('role', 'resident')->get();
        $blocks = \App\Models\Block::with('floors.apartments')->get();
        return view('receptionist.temporary-registrations.edit', compact('temporaryRegistration', 'users', 'blocks'));
    }
