...
<div class="inv-container">
    ...
    <div class="inv-header">
        ...
        <a href="{{ route('resident.invoices.history') }}" class="inv-btn inv-btn--primary" style="text-decoration: none;">
            📊 Sao kê thanh toán
        </a>
    </div>
            ...
            @foreach($invoices as $invoice)
                ...
                <div class="inv-card inv-card--{{ $invoice->status }}">
                    ...
                    <div class="inv-card__right">
                        ...
                        @if($isPending)
                            <a href="{{ route('resident.invoices.payment-gateways', $invoice->id) }}" class="inv-btn inv-btn--primary" style="display: inline-block; text-decoration: none; text-align: center;">
                                Thanh toán
                            </a>
                        @endif
                    </div>
