...
<head>
    ...
    <title>DomusHub – Đăng nhập Lễ tân</title>
...
<div class="card">
    ...
    <div class="logo">
        <div class="logo-icon"><i class="fa-solid fa-concierge-bell"></i></div>
        DomusHub Lễ tân
    </div>

    <h2>Xin chào, Lễ tân</h2>
    <p class="sub">Đăng nhập để truy cập hệ thống quản lý lễ tân DomusHub.</p>
