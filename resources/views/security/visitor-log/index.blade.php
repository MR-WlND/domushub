...
@section('page_title', 'Lịch sử ra vào — DomusHub')
@push('styles')
<style>
...
.vl-filter-inp,.vl-filter-sel {
    background:#f8fafc; border:1.5px solid #e2e8f0; border-radius:8px;
    padding:.5rem .75rem; font-size:.85rem; font-family:inherit; color:#1e293b;
...
/* SPIN */
.vl-spin { width:14px; height:14px; border:2px solid rgba(255,255,255,.3); border-top-color:#fff; border-radius:50%; animation:vlspin .7s linear infinite; }
...
<div class="vl-wrap">
    ...
    {{-- FILTERS --}}
    <form method="GET" action="{{ route('security.visitor-log.index') }}">
        <div class="vl-filters">
            ...
            <div class="vl-filter-actions">
                ...
                <a href="{{ route('security.visitor-log.index') }}" class="vl-btn vl-btn--outline">Xoá lọc</a>
            </div>
        </div>
    </form>
