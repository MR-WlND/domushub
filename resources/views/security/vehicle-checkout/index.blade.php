...
@section('page_title', 'Quét QR Xe Ra — DomusHub')
...
<div class="qs-page">
    ...
    <div class="qs-header">
        ...
        <h1 class="qs-title">Quét QR — Xe Ra</h1>
    </div>
    ...
    <div class="qs-layout">
        ...
        <div class="qs-result" id="result-panel">
            <div class="qs-result__idle" id="idle-state">
                ...
                <h3 class="qs-result__idle-title">Sẵn sàng quét xe ra</h3>
...
function doScan(token) {
    ...
    fetch('{{ route("security.vehicle-checkout.scan") }}', {
        method: 'POST',
    ...
    if (data.success) {
        ...
        body.innerHTML = v ? `
            ...
            <div class="qs-warn-box" style="background:rgba(239,68,68,.15);border-color:rgba(239,68,68,.3);color:#fca5a5;">
                <span>✕</span><span>${data.message || 'Xe chưa check-in hoặc thông tin không hợp lệ.'}</span>
            </div>
