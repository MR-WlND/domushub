        ...
        <form action="{{ portal_route('apartment-types.store') }}" method="POST">
            ...
            <div class="form-grid-2" style="margin-top: 24px;">
                ...
                <div class="form-group-custom">
                    ...
                    <div class="input-wrapper-custom">
                        ...
                        <input type="number" name="living_room_count" value="{{ old('living_room_count', 1) }}" class="form-input-custom @error('living_room_count') input-error @enderror" min="0" max="10">
                    </div>
                ...
                <div class="form-group-custom">
                    ...
                    <div class="input-wrapper-custom">
                        ...
                        <input type="text" name="balcony_direction" value="{{ old('balcony_direction') }}" placeholder="VD: Đông Nam..." class="form-input-custom @error('balcony_direction') input-error @enderror">
                    </div>
            ...
            <div class="form-group-custom" style="margin-bottom: 24px;">
                ...
                <div class="input-wrapper-custom">
                    ...
                    <input type="text" name="furniture_status" value="{{ old('furniture_status') }}" placeholder="VD: Full nội thất cơ bản..." class="form-input-custom @error('furniture_status') input-error @enderror">
                </div>
