            ...
            <div class="amf-grid">
                ...
                <div class="amf-field">
                    ...
                    <select id="slot_duration" name="slot_duration">
                        <option value="0"   {{ old('slot_duration','60') === '0'   ? 'selected' : '' }}>Cả ngày (1 slot duy nhất)</option>
            ...
            <div class="amf-grid">
                ...
                <div class="amf-field amf-field--wide">
                    ...
                    <div class="amf-booking-type-wrap">
                        <label class="amf-type-card {{ old('booking_type','slot') === 'slot' ? 'amf-type-card--active' : '' }}" id="typeCardSlot">
                            <input type="radio" name="booking_type" value="slot" id="typeSlot"
                                {{ old('booking_type','slot') === 'slot' ? 'checked' : '' }}>
                        ...
                        <label class="amf-type-card {{ old('booking_type') === 'person' ? 'amf-type-card--active' : '' }}" id="typeCardPerson">
                            <input type="radio" name="booking_type" value="person" id="typePerson"
                                {{ old('booking_type') === 'person' ? 'checked' : '' }}>
                            <span class="amf-type-icon"></span>
                            <span class="amf-type-info">
                ...
                {{-- Giá theo người --}}
                <div class="amf-field" id="pricePersonWrap" style="display:none">
                    ...
                    <div class="amf-input-group">
                        <input type="number" id="price_per_person" name="price_per_person"
                            value="{{ old('price_per_person', 0) }}" min="0" step="1000"
