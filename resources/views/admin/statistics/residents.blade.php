...
<div class="stat-page">
    ...
    <div class="stat-header">
        ...
        <div class="stat-header__filter">
            <form method="GET" action="{{ portal_route('statistics.residents') }}" class="year-filter-form">
            ...
            <a href="{{ portal_route('statistics.residents.export', ['block_id' => $selectedBlock, 'year' => $selectedYear, 'month' => $selectedMonth]) }}" class="btn-export">
