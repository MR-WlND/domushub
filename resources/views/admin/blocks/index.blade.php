                ...
                <div class="infra-featured-card">
                    ...
                    <div class="infra-featured__header">
                        <div class="infra-featured__info">
                            ...
                            <div>
                                <a href="{{ portal_route('blocks.show', $featuredBlock->id) }}" style="text-decoration: none; color: inherit; display: inline-block;">
                                    <h2 class="infra-featured__name" style="transition: color 0.2s;" onmouseover="this.style.color='#1d4ed8'" onmouseout="this.style.color=''">{{ $featuredBlock->name }}</h2>
                                </a>
