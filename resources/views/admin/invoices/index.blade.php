        ...
        <table class="inv-admin__table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($inv->status === 'paid')
                            @php $paidPayment = $inv->payments->where('status','success')->first(); @endphp
                            <span class="inv-admin__badge inv-admin__badge--paid">✅ Đã TT</span>
                            @if($paidPayment)
                                <div class="inv-admin__sub" style="margin-top:3px;">
                                    {{ match($paidPayment->payment_method) {
                                        'mbbank' => 'MB Bank',
                                        'vnpay'  => 'VNPay',
                                        'cash'   => 'Tiền mặt',
                                        'bank_transfer' => 'Chuyển khoản',
                                        default  => $paidPayment->payment_method
                                    } }}
                                </div>
                            @endif
