            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select
                        ...
                        required
                    >
                        <option value="resident" {{ old('floor_type', $floor->floor_type) == 'resident' ? 'selected' : '' }}>
                            Cư dân
                        </option>
                        <option value="basement" {{ old('floor_type', $floor->floor_type) == 'basement' ? 'selected' : '' }}>
                            Tầng hầm
                        </option>
                        <option value="commercial" {{ old('floor_type', $floor->floor_type) == 'commercial' ? 'selected' : '' }}>
                            Thương mại
                        </option>
                        <option value="service" {{ old('floor_type', $floor->floor_type) == 'service' ? 'selected' : '' }}>
                            Tiện ích
                        </option>
                    </select>
