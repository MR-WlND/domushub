...
<div class="db-page">
    ...
    <div class="kpi-grid">
        <a href="{{ portal_route('blocks.index') }}" class="kpi-card kpi-card--blue db-kpi-link">
            <div class="kpi-icon">
        ...
        <a href="{{ portal_route('apartments.index') }}" class="kpi-card kpi-card--indigo db-kpi-link">
            <div class="kpi-icon">
    ...
    <div class="db-alerts-row">
        ...
        <a href="{{ portal_route('tickets.index', ['status' => 'pending']) }}" class="db-alert-card db-alert-card--amber">
        ...
        <a href="{{ portal_route('vehicles.index') }}" class="db-alert-card db-alert-card--blue">
            <div class="db-alert-icon">
        ...
        <a href="{{ portal_route('amenities.bookings') }}" class="db-alert-card db-alert-card--indigo">
            <div class="db-alert-icon">
        ...
        <div class="db-col-left">
            ...
            <div class="chart-card">
                <div class="chart-card__header">
                    ...
                    <a href="{{ portal_route('tickets.index') }}" class="db-link-btn">
                        Xem tất cả
                ...
                <div class="table-wrap">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr style="cursor:pointer;" onclick="window.location='{{ portal_route('tickets.show', $ticket->id) }}'">
            ...
            <div class="chart-card">
                <div class="chart-card__header">
                    ...
                    <a href="{{ portal_route('amenities.bookings') }}" class="db-link-btn">
                        Xem tất cả
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>
                    </a>
                </div>
        ...
        <div class="db-col-right">
            ...
            <div class="chart-card">
                ...
                <div class="db-quick-grid">
                    <a href="{{ portal_route('blocks.create') }}" class="db-quick-btn db-quick-btn--blue">
                    ...
                    <a href="{{ portal_route('floors.create') }}" class="db-quick-btn db-quick-btn--indigo">
                    ...
                    <a href="{{ portal_route('apartments.create') }}" class="db-quick-btn db-quick-btn--green">
                    ...
                    <a href="{{ portal_route('users.create') }}" class="db-quick-btn db-quick-btn--blue">
            ...
            <div class="chart-card">
                ...
                <div class="db-report-links">
                    <a href="{{ portal_route('statistics.finance') }}" class="db-report-item">
                    ...
                    <a href="{{ portal_route('statistics.operations') }}" class="db-report-item">
                    ...
                    <a href="{{ portal_route('statistics.residents') }}" class="db-report-item">
                    ...
                    <a href="{{ portal_route('amenities.statistics') }}" class="db-report-item">
                    ...
                    <a href="{{ portal_route('invoices.stats') }}" class="db-report-item">
