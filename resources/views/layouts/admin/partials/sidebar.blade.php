<aside class="dashboard-sidebar">
    ...
    <nav class="dashboard-nav">
        <a href="#" class="dashboard-nav__item {{ request()->routeIs('admin.analytics') ? 'dashboard-nav__item--active' : '' }}">
        ...
        <a href="#" class="dashboard-nav__item {{ request()->routeIs('admin.requests') ? 'dashboard-nav__item--active' : '' }}">
            <svg class="dashboard-nav__icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="#" class="dashboard-nav__item {{ request()->routeIs('admin.residents') ? 'dashboard-nav__item--active' : '' }}">
            <svg class="dashboard-nav__icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="#" class="dashboard-nav__item {{ request()->routeIs('admin.settings') ? 'dashboard-nav__item--active' : '' }}">
            <svg class="dashboard-nav__icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="dashboard-sidebar__bottom">
        <button class="btn-new-broadcast">
